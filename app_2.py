...
#app2 = dash.Dash(__name__, title="Dashboard",external_scripts=external_scripts,requests_pathname_prefix='/app2/',external_stylesheets=[dbc.themes.SLATE])
...
app2.layout = html.Div([dcc.Location(id="url"), sidebar, content])
